...
#
# Logo images should be 64 x 128 px PNG's
...
puts "// copy this to ../../../production_demo_rev_A/logo.h"

#filename = "PalonenLABS_128x64px"
filename = "amperi_logo"

puts "extern uint8_t const CAL_PGM(FLASHPICS_#{filename}[]);"

# output actual data
puts "\n\n// copy this to ../../../production_demo_rev_A/logo.c"
