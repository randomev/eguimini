...
#	Licenced under LGPL
#	
#	(c) Henry Palonen <h@yty.net> 2009
#
#
...
def png2hex(filename)
	...
	puts "uint8_t const CAL_PGM_DEF(FLASHPICS_ECARS_#{defname}[]) = {"
...
#(0..9).each do |i|
#	filename = "DEMO_" + i.to_s
#	puts "extern uint8_t const CAL_PGM(FLASHPICS_ECARS_#{filename}[]);"
#end
